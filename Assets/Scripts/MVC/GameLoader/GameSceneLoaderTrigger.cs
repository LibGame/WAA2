...
public class GameSceneLoaderTrigger : MonoBehaviour
{
    ...
    private void OnEnable()
    {
        ...
        castleView.Init(_canHireCreatureSlots, _heroGarrisonSlot, _heroCasstleSlot,_strategyCamera,_castleExitButton, _councilButton, _castle, _terrainObjectsParent, _buildingsObjects, _playerPanel);

...
namespace Assets.Scripts.MVC.CastleMVC.View
{
    public class CastleView : MonoBehaviour
    {
        ...
        public void Init(CanHireCreatureSlots canHireCreatureSlots, HeroSlot garrisonSlot, HeroSlot castleSlot, StrategyCamera strategyCamera, Button exitButton, Button openCouncilButton, GameObject castle, Transform terrainObjectsParent, GameObject buildings, GameObject playerPanel)
        {
